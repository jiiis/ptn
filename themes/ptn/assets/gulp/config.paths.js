...
var dirAssets = path.join(__dirname, '..'),
    ...
    scripts: {
        ...
        src: {
            shared: {
                top: {
                    files: [
                        path.join(dirVendors, 'selectivizr', 'selectivizr.js'),
                        path.join(dirVendors, 'respond', 'dest', 'respond.src.js'),
                        path.join(dirVendors, 'html5shiv', 'dist', 'html5shiv.js')
                    ]
                },
                bottom: {
                    files: [
                        path.join(dirVendors, 'jquery', 'dist', 'jquery.js'),
                        path.join(dirVendors, 'malihu-custom-scrollbar-plugin', 'jquery.mCustomScrollbar.js'),
                        path.join(dirVendors, 'Waves', 'dist', 'waves.js'),
